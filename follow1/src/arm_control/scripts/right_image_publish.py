...
def main():
    ...
    serial_number_dict = {'mid_white':'234322070358', 'left_black':'317622074564', 'right_white': '207222070486'}

    Right_pipeline = configure_camera(serial_number_dict['right_white'])


    # 初始化ROS节点
    rospy.init_node('right_camera_publisher')

    # 创建CvBridge对象，用于ROS图像消息和OpenCV图像格式之间的转换
    bridge = CvBridge()

    # 创建一个发布者，发布图像到指定的ROS话题
    image_pub = rospy.Publisher('/right_camera', Image, queue_size=10)
