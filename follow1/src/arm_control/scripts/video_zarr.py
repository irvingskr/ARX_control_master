...
if __name__ == "__main__":
    # 示例用法
    zarr_path = "/home/arxpro/ARX_Remote_Control/data/6_2_plus_plus.zarr/data/img_mid"
    output_video = "/home/arxpro/ARX_Remote_Control/data/6_2_plus_plus.zarr/data/output_video.mp4"
