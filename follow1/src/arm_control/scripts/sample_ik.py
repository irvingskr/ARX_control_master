...
step = 0
Max_step = 100
directory_path = f'/media/dc/ESD-USB/0109_hardware_for_video_gen_test'# f'/media/dc/HP2024/data/SCIL/Task4_long_horizon'
extension = '.hdf5' 
...
if __name__ =="__main__":
    ...
    ats = ApproximateTimeSynchronizer([master1,follow1,follow1_pos,image_mid],slop=0.1,queue_size=2)
