...
directory_path = f'/home/arxpro/ARX_Remote_Control/data/6_3_drawer_ep15' # f'/media/dc/ESD-USB/1120-remote-data'# f'/media/dc/HP2024/data/SCIL/Task4_long_horizon'
extension = '.zarr' 
