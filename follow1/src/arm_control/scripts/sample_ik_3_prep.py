...
step = 0
Max_step = 100
directory_path = f'/media/dc/XiaoXiong/april_test_tasks/put_the_blue_bowl_on_the_big_plate'# f'/media/dc/HP2024/data/SCIL/Task4_long_horizon'
extension = '.hdf5' 
...
def callback(JointCTR2,JointInfo2,f2p,image_mid,image_right,image_left):
...
if __name__ =="__main__":
    ...
    rospy.init_node("sample_ik_3_prep")
    ...
    print("before ats")
    ats = ApproximateTimeSynchronizer([master1,follow1,follow1_pos,image_mid, image_right, image_left],slop=0.3,queue_size=2)
