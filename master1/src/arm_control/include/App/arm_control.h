...
/* currently, one mission one class, if there exists multi mission and share arm variables, 
either use a more gerenal class including mission instance or use global struct
*/
